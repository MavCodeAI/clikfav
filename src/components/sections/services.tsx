        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative bg-linear-to-br from-white to-primary-50 border-2 border-primary-200 rounded-2xl p-8 hover:border-primary-500 transition-all duration-500 shadow-lg hover:shadow-2xl"
            >
              <div className="flex flex-col items-center text-center">
                <motion.div 
                  ...
                  transition={{ duration: 0.6 }}
                  className="w-20 h-20 bg-linear-to-br from-primary-500 to-primary-700 rounded-2xl flex items-center justify-center mb-6 group-hover:from-primary-600 group-hover:to-primary-800 transition-all duration-500 shadow-xl"
                >
                  <service.icon className="w-10 h-10 text-white" />
                </motion.div>
                
                <div className="text-base font-black text-primary-600 mb-3 tracking-wider">
                  {service.code}
                </div>
                
                <h3 className="text-xl font-black text-neutral-900 mb-4 leading-tight">
                  {service.name}
                </h3>
